...
import { Animated, Dimensions, Easing, KeyboardAvoidingView, Platform, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
export default function WelcomeScreen() {
  ...
  const welcomeScale = {
    ...
    opacity: welcomeAnim.interpolate({ inputRange: [0.85, 1], outputRange: [0.5, 1] }),
  };
  ...
  function SigningInDots() {
    ...
    return (
      <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 6 }}>
        <Animated.View style={{ opacity: dot1, transform: [{ scale: dot1.interpolate({ inputRange: [0, 1], outputRange: [0.7, 1.2] }) }], marginHorizontal: 1.5, width: 7, height: 7, borderRadius: 4, backgroundColor: '#fff' }} />
        <Animated.View style={{ opacity: dot2, transform: [{ scale: dot2.interpolate({ inputRange: [0, 1], outputRange: [0.7, 1.2] }) }], marginHorizontal: 1.5, width: 7, height: 7, borderRadius: 4, backgroundColor: '#fff' }} />
        <Animated.View style={{ opacity: dot3, transform: [{ scale: dot3.interpolate({ inputRange: [0, 1], outputRange: [0.7, 1.2] }) }], marginHorizontal: 1.5, width: 7, height: 7, borderRadius: 4, backgroundColor: '#fff' }} />
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        >
          ...
          <Animated.View style={[styles.wave, waveTranslate]}>
            ...
            >
              <Path
                d={`M0,100 Q${width * 0.25},60 ${width * 0.5},100 Q${width * 0.75},140 ${width},100 L${width},260 L0,260 Z`}
                fill="#fff"
              />
            </Svg>
          </Animated.View>
      ...
      <Animated.View style={[styles.content, welcomeScale]}>
        ...
        <TouchableOpacity style={styles.createButton} onPress={handleCreateAccount} accessibilityRole="button">
          <LinearGradient
        ...
        {!showLogin && (
          <Animated.View style={{
            ...
            transform: [{ translateY: loginButtonAnim.interpolate({ inputRange: [0, 1], outputRange: [30, 0] }) }],
            width: '100%',
            alignItems: 'center',
          }}>
      ...
      {showLogin && (
        <Animated.View style={[styles.loginModal, slideDown]}>
          ...
          >
            <TouchableOpacity style={styles.closeButton} onPress={handleCloseLogin} accessibilityLabel="Close login">
              <Ionicons name="close" size={22} color="#197C47" />
            </TouchableOpacity>
            <Text style={styles.loginHeading}>Sign in to FridgeWise</Text>
            <View style={styles.form}>
              <View style={[styles.inputGroup, emailFocused && styles.inputGroupFocused, hasLoginError && styles.inputGroupError]}>
              ...
              <View style={[styles.inputGroup, passwordFocused && styles.inputGroupFocused, hasLoginError && styles.inputGroupError]}>
              ...
              {hasLoginError && (
                <Text style={{ color: '#D32F2F', fontSize: 14, marginTop: 2, marginBottom: 8, fontWeight: '600' }}>Invalid email or password</Text>
              )}
